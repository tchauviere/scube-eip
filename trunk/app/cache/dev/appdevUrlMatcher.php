...
class appdevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // AcmeScubeBundle_homepage
        if (rtrim($pathinfo, '/') === '/base') {
            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($pathinfo.'/', 'AcmeScubeBundle_homepage');
            }
            return array (  '_controller' => 'Acme\\ScubeBundle\\Controller\\ScubeController::indexAction',  '_route' => 'AcmeScubeBundle_homepage',);
        }
