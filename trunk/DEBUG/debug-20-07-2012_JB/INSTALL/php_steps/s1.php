...
?>
    <div class="symfony-block-content">
        ...
        <p>Are you ready to make <strong>your own social network</strong> ? This script will guide you through the error detection step.</p>
        <p></p>

        <?php if (count($majorProblems)): ?>
            <h2 class="error">
                 Major problems (<?php echo count($majorProblems) ?>)
            </h2>
        ...
        <?php if (count($minorProblems)): ?>
            <h2 class="warning">Recommendations  (<?php echo count($minorProblems) ?>)</h2>
            <p>
                <?php if ($majorProblems): ?>
                    Additionally, to
                <?php else: ?>
                    To<?php endif; ?>
                enhance your Scube experience, it’s recommended that you fix the following :
            </p>
            <ol>
        ...
        <a class="button_reload" href="#" onclick="step_1();"><img src="images/reload.png" alt="Reload" /> Re-Check configuration</a>
        <?php if (!count($majorProblems)): ?>
            <a class="button_nextstep" href="#" onclick="step_2();">Next step <img src="images/next.png" alt="Next" /></a>
        <?php endif ?>
        </div>
    </div>