...
class BaseController extends CoreController
{
    ...
    public function indexAction(Request $request)
    {
		...
		if ($session->get('user'))
		{
			...
			if ($this->isMobile())
				return $this->render('ScubeBaseBundle:Base_Mobile:index.html.twig', array("site_info" => $this->getSiteInfos(),'user' => $user));
			return $this->render('ScubeBaseBundle:Base:index.html.twig', array("site_info" => $this->getSiteInfos(),'user' => $user, 'dashboard_width'=>$dashboard_width, 'dashboard_height'=>$dashboard_height));
		}
		/* User not logged -> display login form */
		else
		{
			$this->preprocessPage(false);
			...
			if ($request->getMethod() == 'POST') {
				...
				if ($form->isValid()) {
					...
					$user = $repository->findOneBy(array('email' => $LoggingUser->getEmail(), 'password' => $this->hashPassword($LoggingUser->getPassword())));
					...
					if ($this->isMobile())
						return $this->render('ScubeBaseBundle:Base_Mobile:login.html.twig', array("site_info" => $this->getSiteInfos(),'allow_registration'=>$allow_registration, 'form' => $form->createView(), 'error' => $error, 'blocked' => $blocked));
					return $this->render('ScubeBaseBundle:Base:login.html.twig', array("site_info" => $this->getSiteInfos(),'allow_registration'=>$allow_registration, 'form' => $form->createView(), 'error' => $error, 'blocked' => $blocked));
				}
			}
	...
	public function registerAction(Request $request)
    {
		...
		{
			if ($this->isMobile())
				return $this->render('ScubeBaseBundle:Base_Mobile:register.html.twig', array("site_info" => $this->getSiteInfos(),"allow_registration"=>false, "success"=>false));
			return $this->render('ScubeBaseBundle:Base:register.html.twig', array("site_info" => $this->getSiteInfos(),"allow_registration"=>false, "success"=>false));
		}
		...
		if ($request->getMethod() == 'POST') {
			...
			if ($form->isValid()) {
				...
				{
					if ($this->isMobile())
						return $this->render('ScubeBaseBundle:Base_Mobile:register.html.twig', array("site_info" => $this->getSiteInfos(),"allow_registration"=>$allow_registration,'form' => $form->createView(),"success"=>false,"error_email"=>true));
					return $this->render('ScubeBaseBundle:Base:register.html.twig', array("site_info" => $this->getSiteInfos(),"allow_registration"=>$allow_registration,'form' => $form->createView(),"success"=>false,"error_email"=>true));
				}
				...
				if ($this->isMobile())
					return $this->render('ScubeBaseBundle:Base_Mobile:register.html.twig', array("site_info" => $this->getSiteInfos(),"allow_registration"=>$allow_registration,"success"=>true));
				return $this->render('ScubeBaseBundle:Base:register.html.twig', array("site_info" => $this->getSiteInfos(),"allow_registration"=>$allow_registration,"success"=>true));
			}
		}
			
		return $this->render('ScubeBaseBundle:Base:register.html.twig', array("site_info" => $this->getSiteInfos(),"allow_registration"=>$allow_registration,'form' => $form->createView(), "success"=>false));
    }
	/* Ajax calls */
	public function frame_profileAction(Request $request)
    {
    	...
    	if ($this->user) {			
			return $this->render('ScubeBaseBundle:Base:core_homebox.html.twig', array('user' => $this->user));
		}
    }
