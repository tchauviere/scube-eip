...
<html>
    <head>
        ...
        <title>Scube Installation step 1</title>
    </head>
    <body>
        <div id="symfony-wrapper">
            <div id="symfony-content">
                ...
                <div class="symfony-block-content">
                    <h1>Welcome in Scube !</h1>
                    <p>Are you ready to make your own social network ?</p>
                    <p>This script will guide you through the error detection step.</p>
                    ...
                    <ul class="symfony-install-continue">
                        <?php if (!count($majorProblems)): ?>
                            <li><a href="install_2.php">Go to step 2</a></li>
                        <?php endif ?>
                        <li><a href="install.php">Re-check configuration</a></li>
                    </ul>
                </div>
            </div>
        </div>
