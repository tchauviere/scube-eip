...
class InterfaceWidget
{
	...
	/**
     * @ORM\OneToOne(targetEntity="Scube\BaseBundle\Entity\Widgets")
     * @ORM\JoinColumn(name="widgets", referencedColumnName="id")
     */
    protected $widget;
     ...
     * Set widget
     *
     * @param Scube\BaseBundle\Entity\Apps $widget
     */
    public function setWidget(\Scube\BaseBundle\Entity\Apps $widget)
    {
        $this->widget = $widget;
    }
